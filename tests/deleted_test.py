...
assert r["graded"] == 1
# one surviving fixture, marked 6 out of 10, so 1.8 of its 3
assert abs(r["points"]["homework"] - 1.8) < 0.01, r["points"]["homework"]
print("   the three 10s from deleted tasks no longer score:",
      r["points"]["homework"], "(6/10 of one fixture worth 3)")
